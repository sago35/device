...
var (
	...
	_ = interrupt.Register(IRQ_SERCOM4, "SERCOM4_IRQHandler")
	_ = interrupt.Register(IRQ_SERCOM5, "SERCOM5_IRQHandler")
	...
	_ = interrupt.Register(IRQ_AC1, "AC1_IRQHandler")
	_ = interrupt.Register(IRQ_TCC3, "TCC3_IRQHandler")
)
