...
var (
	...
	_ = interrupt.Register(IRQ_Quad_SPI, "Quad_SPI_IRQHandler")
	_ = interrupt.Register(IRQ_I2CFMP1_event, "I2CFMP1_event_IRQHandler")
	_ = interrupt.Register(IRQ_I2CFMP1_error, "I2CFMP1_error_IRQHandler")
)
